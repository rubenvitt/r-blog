...
Bleibt der zweite Begriff, den ich in diesem Post groß mache: "Agent Contract". Auch er steht in keinem Rechtsakt. Michael und ich haben ihn für unsere Arbeit eingeführt, die Aufsicht kennt ihn nicht. DORA nennt seine Verträge "vertragliche Vereinbarungen über die Nutzung von IKT-Dienstleistungen", und das trifft eine Agenten-Entscheidung nicht recht. Wir brauchen ein Wort für das Soll, und "Agent Contract" ist unseres. Die Architektur dahinter löst die bindenden Pflichten ein: Unveränderbarkeit, Protokollierung, Nachvollziehbarkeit, für ein Feature wie unser Kreditscoring aus dem letzten Kapitel.
