...
Die ehrliche Antwort: ohne strukturierte Observability gar nicht. Ein False Success im Refund-Agent - das Tool meldet Erfolg, der Kunde wartet auf sein Geld - ist mit Application Logs und Error Rates nicht zu finden. Alles grün. Das System hat nicht versagt, es hat gelogen.
...
Traditionelle Metriken fangen AI-spezifische Fehler nicht. False Success, falsche Tool-Auswahl oder halluzinierte Aktionen bleiben unsichtbar, solange ich nur auf HTTP-Statuscodes und Exception-Counts schaue. Das Problem sitzt tiefer - in der Entscheidungslogik des Agents und in der Interpretation der Tool-Antworten. Zwischen Turns geht Kontext verloren, ohne dass irgendein Logfile darauf hinweist.
...
Observability für AI-Features ist noch jung. Aber ein paar Fallen haben sich jetzt schon als Klassiker etabliert. Sechs Anti-Patterns, denen ich regelmäßig begegne:
